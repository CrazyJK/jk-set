 ...
 * <pre>
 * &lt;mvc:interceptors&gt;
 *   &lt;beans:bean class="{@link jk.kamoru.spring.web.AccesslogInterceptor}" &gt;
 *     &lt;beans:property name="when" value="#{T({@link jk.kamoru.spring.web.AccesslogInterceptor}${@link WHEN}).{@link WHEN#AFTER AFTER}}"/&gt;
 *   &lt;/beans:bean&gt;
 * &lt;/mvc:interceptors&gt;
 * </pre>
 * @author kamoru
